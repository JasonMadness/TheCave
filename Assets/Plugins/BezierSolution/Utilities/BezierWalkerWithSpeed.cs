...
namespace BezierSolution
{
    ...
    public class BezierWalkerWithSpeed : BezierWalker
    {
        ...
        [SerializeField] [Range(0f, 1f)] private float m_normalizedT = 0f;
        ...
        public override void Execute(float deltaTime)
        {
            ...
            {
                transform.position =
                    spline.MoveAlongSpline(ref m_normalizedT, (isGoingForward ? speed : -speed) * deltaTime);
                RotateTarget(transform, m_normalizedT, LookAtMode.None/*lookAt*/, rotationLerpModifier * deltaTime);
                PostProcessMovement(travelMode, ref onPathCompletedCalledAt0, ref onPathCompletedCalledAt1,
                    onPathCompleted);
            }
        }
    }
